        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
            <h4 className="font-medium text-gray-800 mb-2">
              Task: {selectedTask === 'entity_extraction' ? 'Causal Entity Extraction' : selectedTask === 'relation_classification' ? 'Causal Relation Classification' : 'Single Prompt Full Causal Extraction'}
            </h4>
